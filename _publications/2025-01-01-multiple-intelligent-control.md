...
This paper proposes intelligent control strategies for reducing the travel time of connected emergency vehicles in urban traffic.

The framework combines path planning, signal preemption, and predictive decision-making to improve emergency response while limiting disruption to surrounding traffic.

<img src="/images/publications/multiple-intelligent-control.jpg" alt="Graphical Abstract" width="600" style="border-radius: 8px;" />

---

### Demo Video 1: Integrated System in PTV Vissim
...
### Demo Video 2: Lane Merging to Give Way to Emergency Vehicles
