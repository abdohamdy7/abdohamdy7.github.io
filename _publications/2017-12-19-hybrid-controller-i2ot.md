...
This conference paper presents a hybrid-control framework for a software-defined industrial Internet testbed built around a quadruple-tank benchmark process.

The system combined low-cost IoT-enabled hardware with software-defined control architecture to study distributed process automation and real-time communication.

<img src="/images/publications/hybrid arch.jpg" alt="Graphical Abstract" width="600" style="border-radius: 8px;" />


### Demo Video: Real-time Implementation
...
### Demo Video: Simulink Implementation
